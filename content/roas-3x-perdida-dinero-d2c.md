...
## La Pirámide ROAS: tu diagnóstico en 5 capas
...
El problema: una proporción significativa de esas ventas eran a clientes existentes que habían comprado hacía meses. Su LTV era bajo. Muchos eran compradores por descuento que solo pedían cuando había promoción.

Si no segmentas por tipo de cliente en tu tracking, Advantage+ optimiza por conversiones, no por rentabilidad. Es logic: le pides más ventas a la máquina y te las da. Pero si no le dices qué tipo de ventas,bajo elelas.
